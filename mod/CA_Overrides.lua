...
function Game:init_item_prototypes()
  ...
  for _, booster in pairs(CABoosters) do
    booster:register()
  end
...
function ALCHEMICAL_SAVE_UNLOCKS() 
  ...
  -------------------------------------
  if not NFS.getInfo(G.SETTINGS.profile .. '') then
      NFS.createDirectory(G.SETTINGS.profile ..
          '')
  end
  if not NFS.getInfo(G.SETTINGS.profile .. '/' .. 'meta.jkr') then
      NFS.append(
